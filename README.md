...
2. **会のウェブサイトと Google カレンダーを、この記録からつくる。**
   活動の記録と写真から、会のウェブサイト（[tecolicom.github.io/OMC/](https://tecolicom.github.io/OMC/)）を
...
| `site/` | 会のウェブサイト（[tecolicom.github.io/OMC/](https://tecolicom.github.io/OMC/)）のソース | **公開サイトの中身**（活動一覧・写真・カレンダー） |
...
- **会のウェブサイト**（[tecolicom.github.io/OMC/](https://tecolicom.github.io/OMC/)）で、これまでの活動を
